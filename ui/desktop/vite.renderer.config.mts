...
export default defineConfig({
  ...
  // Local dev only: run-ui.bat sets node-linker=hoisted (required by
  // electron-forge), which makes pnpm 11 resolve a duplicate React and crash
  // react-router with a null useRef. Dedupe forces a single React instance.
  resolve: {
